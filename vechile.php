...
$vehicles = [];
$filterActive = $search !== '' || $stateFilter !== 'all';
...
$usingDemoData = false;
if (count($vehicles) === 0 && !$filterActive && $storedChallanCount === 0) {
    $usingDemoData = true;
    $vehicles = [
        ['vehicle_no' => 'KL07AB1234', 'total_cases' => 3, 'paid_cases' => 1, 'unpaid_cases' => 2, 'total_fine' => 3500, 'latest_challan_id' => 309],
...
$stateOptions = ['KL', 'DL', 'HR', 'UP', 'MH', 'KA', 'GJ', 'PB', 'RJ'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <main class="main">
        ...
        <section class="table-panel" style="margin-top:16px;">
            ...
            <div class="table-note">
                ...
                No vehicles match the current search or state filter.
                <?php } else { ?>
