...
@media print{
    *, *::before, *::after {
    ...
    .sheet{ box-shadow:none; border:1px solid #d8e2ec; }
...
<main class="sheet">
    ...
    <div class="actions">
        ...
        <a class="btn secondary" href="index.php" style="background:#0f172a; color:#fff; border-color:#0f172a;">← Back to Home Page</a>
    </div>
</main>
</body>
</html>
