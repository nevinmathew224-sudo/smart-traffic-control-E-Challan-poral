...
$usingDemoData = false;
if (false && (int) ($totals['total_challans'] ?? 0) === 0) {
    $usingDemoData = true;
    $totals = [
        'total_challans' => 50,
        'paid_challans' => 27,
    ...
    $vehicles = [
        ['vehicle_no' => 'KL07AB1234', 'total_cases' => 4, 'total_fine' => 6500],
...
<div class="shell">
    ...
    <main class="main">
        <div class="topbar">
            ...
            <div class="profile-card">
                ...
                <div class="toolbar">
                    ...
                    <a href="export_csv.php?type=reports" class="primary">Export CSV</a>
                </div>
            </div>
        </div>
        ...
        <?php } elseif ($totalChallans === 0) { ?>
        <div class="table-note" style="margin-bottom:16px;">No challan records are available for reports yet.</div>
        <?php } ?>
