    ...
    <main class="main">
        <div class="topbar">
            ...
            <div class="profile-card">
                ...
                <div class="toolbar">
                    <button type="button" class="primary" onclick="showToast('Settings checked successfully')">Check Status</button>
                </div>
            </div>
        </div>
                ...
                <div class="setting-card">
                    ...
                    <div class="credential-box">
                        <div class="credential">
                            Admin access
                            <code>admin@traffic.com / admin</code>
                        </div>
                        <div class="credential">
                            Citizen access
                            <code>aarav.sharma@trafficdemo.com / user</code>
                        </div>
                    </div>
                </div>
